...
// secret-resolution time (insecureSkipVerify: ${PFLEX1_SKIP_CERTIFICATE}). Backward
// compatible with existing native-bool configs.
type EnvBool struct {
...
// reference resolved later by Resolve).
...
// No-op when the value was a native boolean or omitted.
